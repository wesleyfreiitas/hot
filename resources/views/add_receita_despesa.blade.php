                    ...
                    <div class="form-check form-check-inline">
                      ...
                      <div class="row">
                        <div class="col-6" style="margin-bottom: 12px;">
                            ...
                            <div class="form-group">
                                <label for="categoriaProduto" class="control-label">Forma de pagamento</label>
                            </div><br>
                            <div class="form-group ">
                        ...
                        <div class="col-6">
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <input type="textarea" size="140" class="form-control" id="quantidadeProduto" placeholder="Observacoes do dadasto da conta">
                                </div>
                            </div>
                                <div class="form-group">
                                <div class="input-group">
                                    <div class="switch__container" id="segmento">
                                        ...
                                        <input id="switch-shadow" class="switch switch--shadow" type="checkbox" name="outsourcing" value="outsourcing">
                                        <label for="switch-shadow"></label>

                                    </div>

                                    <div class="form-group" id="divOutsourcing" data-label="outsourcing" style="display: none;">

                                        <div id="outsourcing"><div class="form-group">
                                            <div class="input-group">
                                                <input type="textarea" class="form-control" id="quantidadeProduto" placeholder="quantidade deparcelas">
                                            </div>
                                            <div class="form-group ">
                                                <div class="input-group">
                                                    <select class="form-control" id="categoriaProduto" >
