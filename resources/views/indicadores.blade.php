        ...
        <div class="col-sm-3">
            <div class="card">
                <div class="card-body">
                   <div class="row">
                       <div class="col">
                           <h3>30%</h3 style="margin-left:-17px">
        ...
        <div class="col-sm-3">
            <div class="card">
                <div class="card-body">
                   <div class="row">
                       <div class="col">
                           <h3 id="NovasReservas"></h3 style="margin-left:-17px">
                       </div>
                       <div class="col">
        ...
        <div class="col-sm-3">
            <div class="card">
                <div class="card-body">
                   <div class="row">
                       <div class="col">
                           <h3>0</h3 style="margin-left:-17px">
                       </div>
                       <div class="col">
        ...
        <div class="col-sm-3">
            <div class="card">
                <div class="card-body">
                   <div class="row">
                       <div class="col">
                           <h3>5</h3 style="margin-left:-17px">
                       </div>
                       <div class="col">
